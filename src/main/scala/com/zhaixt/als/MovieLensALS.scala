 ...
 * http://www.tuicool.com/articles/fANvieZ 的下半部分
 * 参考了如下代码：https://github.com/gaapt/als_recom/blob/master/ALSBenchmarkSpark%2Fsrc%2Fmain%2Fscala%2FALSBenchmark.scala
 * ALS最小二乘法
 */
/**
 *
...
object MovieLensALS {
  ...
  def main(args: Array[String]) {
    ...
    //todo 不支持 import scopt.OptionParser
    ...
    def run(params: Params) {
      ...
      val model = new ALS()
        ...
        .setLambda(params.lambda)//设置正则化防止过拟合
